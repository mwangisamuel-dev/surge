...
class SurgeColors {
  ...
  static const cyan = mint;
  static const cyanDim = mintSoft;
  static const gradientCyan = gradientMint;
  static const gradientDark = gradientCard;
  static const cardElevated = cardLight;
  static const violetDim = violetSoft;
}
...
class SurgeTheme {
  static ThemeData get dark => ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          hintStyle:
              const TextStyle(color: SurgeColors.textMuted, fontSize: 14),
        ),
        useMaterial3: true,
      );
}
