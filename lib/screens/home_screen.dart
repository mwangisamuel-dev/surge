...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> _suggestions = [
    {
      'word': 'Ephemeral',
      'hint': 'Lasting a very short time',
      'color': 0xFF7C6EFA
    },
    {
      'word': 'Tenacious',
      'hint': 'Holding firm despite opposition',
      'color': 0xFF4ECDC4
    },
    {
      'word': 'Eloquent',
      'hint': 'Fluent and persuasive in speech',
      'color': 0xFFFF9E7E
    },
    {
      'word': 'Sanguine',
      'hint': 'Optimistic in difficulties',
      'color': 0xFFFFD166
    },
    {
      'word': 'Nonchalant',
      'hint': 'Calm and casually unconcerned',
      'color': 0xFF95C8B0
    },
    {
      'word': 'Insidious',
      'hint': 'Harmful in a subtle way',
      'color': 0xFFB8A9FF
    },
    {
      'word': 'Perspicacious',
      'hint': 'Quick to notice and understand',
      'color': 0xFFFF6B8A
    },
    {
      'word': 'Equivocate',
      'hint': 'Use vague language to avoid truth',
      'color': 0xFF4ECDC4
    },
  ];
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Text('DEBUG: HomeScreen built',
        ...
        if (_loadingWotd)
          ...
          Container(
              ...
              child: Row(children: [
                ...
                Expanded(
                    child: Text('Pull down to refresh when online',
                        style: GoogleFonts.plusJakartaSans(
          ...
          Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(20),
                  border:
                      Border.all(color: SurgeColors.violet.withOpacity(0.2))),
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Row(children: [
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(
          ...
          return Expanded(
              child: GestureDetector(
                  onTap: () => Navigator.push(
                          context, MaterialPageRoute(builder: (_) => AddWordScreen(prefill: _suggestions[idx]['word']?.toString())))
                      .then((_) => _refresh()),
                  child: Container(
                      ...
                      child: Text(_suggestions[idx]['word']?.toString() ?? '',
                          style: GoogleFonts.plusJakartaSans(
                              fontSize: 10,
                              fontWeight: FontWeight.w600,
                              color: SurgeColors.textSecondary),
        ...
        if (_recent.isEmpty)
          ...
          ..._recent.map((w) => GestureDetector(
                onTap: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) =>
                            WordDetailScreen(word: w, onUpdate: _refresh))),
                child: Container(
