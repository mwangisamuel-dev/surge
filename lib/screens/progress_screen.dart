...
class _ProgressScreenState extends State<ProgressScreen> {
  ...
  Widget _buildStreakBanner() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: SurgeColors.warning.withAlpha(51)),
      ),
      child: Row(children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('Current Streak',
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor:
                        AlwaysStoppedAnimation<Color>(color.withAlpha(179)),
                    minHeight: 4,
                  ),
                ),
              ],
  ...
  Widget _buildActivityCalendar() {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Wrap(
          ...
          children: days.map((d) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                color: isActive
                    ? SurgeColors.violet.withAlpha(140)
                    : SurgeColors.surface,
        ...
        const SizedBox(height: 10),
        Row(children: [
          _calLegend(SurgeColors.violet.withAlpha(140), 'Active'),
          const SizedBox(width: 14),
          _calLegend(SurgeColors.surface, 'Inactive',
              border: SurgeColors.border),
          const SizedBox(width: 14),
          _calLegend(SurgeColors.surface, 'Today', border: SurgeColors.mint),
        ]),
      ]),
  ...
  Widget _calLegend(Color color, String label, {Color? border}) =>
      Row(children: [
        ...
        Text(label,
            style:
                GoogleFonts.dmSans(fontSize: 11, color: SurgeColors.textMuted)),
      ]);
      ...
      ...all.map((m) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: unlocked ? SurgeColors.border : SurgeColors.surface)),
          child: Row(children: [
            Text(unlocked ? m['e'] : '🔒',
